...
class config_options(_object):
    ...
    __swig_setmethods__["DEP_LSTMFile"] = _pyfreeling.config_options_DEP_LSTMFile_set
    __swig_getmethods__["DEP_LSTMFile"] = _pyfreeling.config_options_DEP_LSTMFile_get
    if _newclass:
        DEP_LSTMFile = _swig_property(_pyfreeling.config_options_DEP_LSTMFile_get, _pyfreeling.config_options_DEP_LSTMFile_set)
    __swig_setmethods__["SRL_TreelerFile"] = _pyfreeling.config_options_SRL_TreelerFile_set
    __swig_getmethods__["SRL_TreelerFile"] = _pyfreeling.config_options_SRL_TreelerFile_get
    if _newclass:
        SRL_TreelerFile = _swig_property(_pyfreeling.config_options_SRL_TreelerFile_get, _pyfreeling.config_options_SRL_TreelerFile_set)
...
class invoke_options(_object):
    ...
    __swig_setmethods__["SRL_which"] = _pyfreeling.invoke_options_SRL_which_set
    __swig_getmethods__["SRL_which"] = _pyfreeling.invoke_options_SRL_which_get
    if _newclass:
        SRL_which = _swig_property(_pyfreeling.invoke_options_SRL_which_get, _pyfreeling.invoke_options_SRL_which_set)
...
class crf_nerc(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, crf_nerc, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, crf_nerc, name)
    __repr__ = _swig_repr

    def __init__(self, arg2: 'std::wstring const &'):
        this = _pyfreeling.new_crf_nerc(arg2)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
crf_nerc_swigregister = _pyfreeling.crf_nerc_swigregister
crf_nerc_swigregister(crf_nerc)
...
class srl_treeler(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, srl_treeler, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, srl_treeler, name)
    __repr__ = _swig_repr

    def __init__(self, arg2: 'std::wstring const &'):
        this = _pyfreeling.new_srl_treeler(arg2)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
srl_treeler_swigregister = _pyfreeling.srl_treeler_swigregister
srl_treeler_swigregister(srl_treeler)
